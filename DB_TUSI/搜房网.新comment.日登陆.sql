...
left join 
(select date(pc.create_date) days,count(1) total from tb_post_comment pc left join tb_user u on pc.uid=u.id where u.company_id=6000067 group by days ) as ul
